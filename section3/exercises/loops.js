...
// EXPLAIN: 0 1 2 is logged in my terminal. The code written is counting from 0 to the
// highest number just below 3, which is 2. So you get 0 1 2. If the code was written
// <= 3 then the console would evaluate to 0 1 2 3
